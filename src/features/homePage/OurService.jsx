 ...
 return (
   <section className={`bg-black`}>
     ...
     >
       ...
       <div className="flex justify-between md:block gap-1 items-center">
        <div>
         <h2 className="font-headings sm:text-[2.6rem] mb-2 text-[1.6rem] font-semibold ">why should </h2>
         <h3 className="text-brand md:text-[2.5rem] w-full  font-headings text-[1.1rem] mb-0 font-semibold ">you use our services?</h3>
         <p className="text-sm sm:text-lg max-w-[12rem] md:max-w-[35rem] md:text-lg">we always provide the best  and fastest services for our customers</p>
        </div>
