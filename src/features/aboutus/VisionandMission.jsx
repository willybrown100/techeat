  ...
  return (
    <section className="bg-black">
      <article className={`${className} `}>
        <div className="w-[16rem] h-[0.2rem] hidden md:block bg-brand m-auto"></div>
        <h3 className="text-brand text-[1.7rem] mb-[0.3rem] font-headings font-semibold text-center">
          vision and mission
        </h3>
        <div className="w-[16rem] h-[0.2rem] bg-brand hidden md:block m-auto"></div>
