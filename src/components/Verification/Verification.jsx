    ...
    <div className="">
      ...
      <div>
        ...
        <h4 className="text-[10px] w-[250px] text-left text-slate-400">
          We would require you to upload a photo of yourself and your NIN number
          for further legibility proof.
        </h4>
        <div className="">
          <div className="w-[10rem] h-[8rem] border-dashed border-black">
