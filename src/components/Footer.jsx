 ...
 return (
   <footer className="bg-black">
     <article className={`${className}`}>
       ...
       <div className="border-b my-8 mt-4"></div>
         ...
         <div>
           ...
           <div>
             <p className="text-sm text-stone-300">
               get 5% off your first order just by subscribing <br/> to our newsletter
             </p>
           </div>
           <div className="border inline-block pl-[2px]">
             <input
               type="email"
               className="bg-stone-600 border-none focus:border-none"
       ...
       <div className="flex mt-[10rem] text-stone-300 justify-between">
         <p className="text-white">copyright 2024 TechEat,All Rights reserved.</p>
