...
export default function PopularMenu({item,onClick,isPending}) {
  ...
  return (
    <li className="bg-white rounded-md">
      <img
        src={image}
        alt="img"
        className="rounded-tl-md h-[13rem] object-cover rounded-tr-md"
      />
      <div className="p-2">
        <div className="flex items-center justify-between ">
          <div className="flex text-black gap-y-2 flex-col">
            ...
            <img src="/images/3star.png" alt="img" className="w-[5rem]" />
          </div>
