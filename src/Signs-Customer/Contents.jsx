...
const Contents = () => {
  return (
    <div className="">
      <form className=" absolute bg-opacity-10 bg-white backdrop-blur-xl shadow-2xl w-[550px] h-[45rem] mt-[-4rem] p-[5rem]">
        <h1 className=" font-Roboto Slab w-[400px] font-bold text-[22px] text-left text-white">
          Welcome to TECH EATS
        </h1>
        <h4 className=" text-[10px] w-[400px] text-left text-slate-400">
